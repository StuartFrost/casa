...
group :test do
  ...
  gem "selenium-webdriver", "4.5.0" # temporarily locking to a beta version until 4.x comes out - to fix docker tests https://github.com/SeleniumHQ/selenium/issues/9001
